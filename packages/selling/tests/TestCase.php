...
namespace JeffersonGoncalves\Erp\Selling\Tests;
...
abstract class TestCase extends Orchestra
{
    ...
    protected function setUp(): void
    {
        ...
        Factory::guessFactoryNamesUsing(function (string $modelName): string {
            ...
            foreach (['Selling', 'Stock', 'Accounting', 'Core'] as $package) {
            ...
            return "JeffersonGoncalves\\Erp\\Selling\\Database\\Factories\\{$basename}Factory";
        });
    }
    ...
    protected function getEnvironmentSetUp($app): void
    {
        ...
        $configPath = __DIR__.'/../config/erp-selling.php';
        if (file_exists($configPath)) {
            $app['config']->set('erp-selling', require $configPath);
        }
    }

    protected function defineDatabaseMigrations(): void
    {
        $tempPath = sys_get_temp_dir().'/laravel-erp-selling-migrations';
        ...
        // across the core, accounting, stock and selling packages (core first,
        // then accounting, then stock, then selling).
        $ordered = array_merge(
