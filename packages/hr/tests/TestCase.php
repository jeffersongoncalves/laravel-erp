...
namespace JeffersonGoncalves\Erp\Hr\Tests;
...
abstract class TestCase extends Orchestra
{
    ...
    protected function setUp(): void
    {
        ...
        Factory::guessFactoryNamesUsing(function (string $modelName): string {
            ...
            foreach (['Hr', 'Accounting', 'Core'] as $package) {
            ...
            return "JeffersonGoncalves\\Erp\\Hr\\Database\\Factories\\{$basename}Factory";
        });
    }
    ...
    protected function getEnvironmentSetUp($app): void
    {
        ...
        $configPath = __DIR__.'/../config/erp-hr.php';
        if (file_exists($configPath)) {
            $app['config']->set('erp-hr', require $configPath);
        }
    }

    protected function defineDatabaseMigrations(): void
    {
        $tempPath = sys_get_temp_dir().'/laravel-erp-hr-migrations';
        ...
        // across the core, accounting and hr packages (core first, then
        // accounting, then hr).
        $ordered = array_merge(
