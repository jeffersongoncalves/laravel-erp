...
namespace JeffersonGoncalves\Erp\Stock\Tests;
...
abstract class TestCase extends Orchestra
{
    ...
    protected function setUp(): void
    {
        ...
        Factory::guessFactoryNamesUsing(function (string $modelName): string {
            ...
            foreach (['Stock', 'Accounting', 'Core'] as $package) {
            ...
            return "JeffersonGoncalves\\Erp\\Stock\\Database\\Factories\\{$basename}Factory";
        });
    }
    ...
    protected function getEnvironmentSetUp($app): void
    {
        ...
        $configPath = __DIR__.'/../config/erp-stock.php';
        if (file_exists($configPath)) {
            $app['config']->set('erp-stock', require $configPath);
        }
    }

    protected function defineDatabaseMigrations(): void
    {
        $tempPath = sys_get_temp_dir().'/laravel-erp-stock-migrations';
        ...
        // across the core, accounting and stock packages (core first, then
        // accounting, then stock).
        $ordered = array_merge(
