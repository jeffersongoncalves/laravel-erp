...
/**
 * Receives stock from a supplier: an inbound movement valued at the receipt
 * rate, posted to the inventory account against "Stock Received But Not Billed".
 *
 * @property int $id
 ...
 */
class PurchaseReceipt extends Model implements PostsStockLedger, PostsToLedger, SubmittableDocument
{
    use HasCompany;
    use HasFactory;
    use HasNamingSeries;
    ...
    /** The "Stock Received But Not Billed" account the value is credited to. */
    ...
    {
        static::saving(function (PurchaseReceipt $receipt): void {
    ...
    {
        return (config('erp-stock.table_prefix') ?? '').'purchase_receipts';
    }
    ...
    {
        return $this->hasMany(ModelResolver::purchaseReceiptItem(), 'purchase_receipt_id');
    }
